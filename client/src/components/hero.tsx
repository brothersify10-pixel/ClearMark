        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
              Book streak-free window cleaning from insured local pros. Fast quotes, transparent pricing, and a satisfaction guarantee.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
            <Button size="lg" className="w-full sm:w-auto font-bold text-xl px-10 h-16 shadow-primary/25 shadow-xl hover:shadow-primary/40 transition-all scale-105">
              Get an Instant Quote
            </Button>
            <Button size="lg" variant="outline" className="w-full sm:w-auto font-bold text-base px-8 h-12 bg-background/50 backdrop-blur hover:bg-background">
              Our Services
            </Button>
          </div>
